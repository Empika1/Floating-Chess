...
public class Board extends JPanel implements MouseListener, MouseMotionListener {
    ...
    public ArrayList<Piece> getWhitePiecesStartingPosition() { //creates an arraylist of all the white pieces in their normal chess starting position
        int id = 16;
    ...
    public ArrayList<Piece> getBlackPiecesStartingPosition() { //creates an arraylist of all the black pieces in their normal chess starting position
        int id = 0;
