...
public record Move(ArrayList<Piece> whitePieces, ArrayList<Piece> blackPieces, ArrayList<Piece> whitePiecesCaptured,
        ArrayList<Piece> blackPiecesCaptured, int whiteTimeLeft, int blackTimeLeft, int turnNumber) implements Serializable { //stores everything required to store a full board state
