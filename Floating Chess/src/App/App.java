...
public class App {
    ...
    public static void displayTimeControlDialog() { // displays the InputDialog to choose a time control when starting a
                                                    // game
        String[] options = { "1 minute", "3 minute", "5 minute", "10 minute", "20 minute", "30 minute", "1 hour",
                "1 day" };
    ...
    public static void displayGameScreen(int time) { // displays game screen with the chosen time control and changes
                                                     // title
