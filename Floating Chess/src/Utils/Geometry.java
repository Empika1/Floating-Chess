...
public class Geometry {
    ...
    public static Vector2[] lineCircleIntersections(Vector2 linePoint, double lineSlope, Vector2 circleCenter,
        ...
        // this is math translated directly into code so it's completely indecipherable
        // lol
        ...
        // return the intersections as an array. always make sure that there are either
        // 0 or 2 intersections, because that's what some other code expects
    ...
    public static boolean isPointInRect(Vector2 oneCorner, Vector2 oppositeCorner, Vector2 point) { // checks if a point
                                                                                                    // is in a rectangle
